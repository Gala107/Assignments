...
public class AppMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// In this case "where u.userName = :nameValue" :nameValue DOES NOT have to match u.userName
			...
			// so we know what instance variable value the parameter is coming from: User object, userName property!
